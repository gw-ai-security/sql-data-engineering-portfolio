...
-- Compare teh Measure values by categories
-- Understand the importance of differnet categories
-- Agg. [Meausre] By [Dimesnsion]
...
-- What is teh distribution of sold items across countries?
SELECT
c.country,
