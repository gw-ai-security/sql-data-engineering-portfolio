...
Actions Performed:
    ...
    - Measures load duration per table and for the complete Silver batch.
    - Reports errors using TRY...CATCH.
...
BEGIN
    ...
    BEGIN CATCH
        ...
        -- Small robustness improvement over the course baseline:
        -- propagate the failure to callers/orchestration instead of only printing it.
        THROW;
    END CATCH
END;
GO
